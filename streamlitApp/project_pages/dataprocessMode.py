...
# file_path = 'BTP_curr.xlsx'
# df = pd.read_excel(file_path, sheet_name='Sheet2Copy')

# # Apply the mapping function to the dataframe
# mapped_df = map_data(df)

# # Write the modified data to a new sheet in the same Excel file
# with pd.ExcelWriter(file_path, mode='a', engine='openpyxl') as writer:
#     mapped_df.to_excel(writer, sheet_name='EncodedData1', index=False)
